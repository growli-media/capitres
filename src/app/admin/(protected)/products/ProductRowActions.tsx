  ...
  return (
    <div className="relative flex items-center justify-end gap-1">
      ...
      <button
        ...
        disabled={pending}
        className="hidden h-9 items-center gap-1.5 rounded-lg px-2.5 text-xs font-semibold text-slate-500 transition-colors hover:bg-slate-100 hover:text-slate-900 disabled:opacity-50 sm:flex"
        ...
        {open && (
          ...
          >
            <button
              ...
              className="flex w-full cursor-pointer items-center px-3 py-2 text-start text-sm text-slate-700 hover:bg-slate-50 sm:hidden"
            >
              Mark sold out
            </button>
            <button
              ...
              className="flex w-full cursor-pointer items-center px-3 py-2 text-start text-sm text-slate-700 hover:bg-slate-50"
            >
            ...
            {confirmingDelete ? (
              <button
                ...
                className="flex w-full cursor-pointer items-center gap-2 px-3 py-2 text-start text-sm font-semibold text-red-600 hover:bg-red-50"
              >
                <Trash size={14} />
